    ...
    return (
        <div className="relative group inline-block">
            <button
                ...
                aria-label='btn'
                data-testid='btn'
                className={`bg-matisse-600 text-curious-blue-50 hover:bg-matisse-500 dark:bg-shark-600 dark:hover:bg-shark-500 dark:border-shark-500 flex h-10 w-auto items-center justify-center whitespace-nowrap rounded-3xl border px-8 py-2 text-lg ${btnProps.disabled ? 'cursor-not-allowed opacity-50' : 'cursor-pointer opacity-100'}`}
