...
import blocklyImage from '@/app/assets/images/blockly.svg';
import pythonImage from '@/app/assets/images/micropython.png';
import { Actions, IJsonTabNode, Layout, Model } from 'flexlayout-react';

type Props = {
    ref : React.RefObject<Layout>
}

/**
 * 
 * @param props - React props contain the reference to the Layout object
 * @returns TSX
 */
function EditorChooser(props: Props) {
    const layoutRef = props.ref;
        ...
        <div className='flex flex-row h-full justify-evenly'>
            ...
            >
                <div className='flex flex-col items-center gap-2'>
                    <Image src={blocklyImage} alt="Blockly Visual Editor" />
                    <span>BLOCKLY</span>
            ...
            >
                <div className='flex flex-col items-center gap-2'>
                    <Image src={pythonImage} className='p-7' alt="MicroPython image" width="190" height="190"/>
